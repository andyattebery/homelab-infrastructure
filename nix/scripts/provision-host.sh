...
echo ""
echo "Optional: set up services user repo"
echo "  ssh root@$HOST_IP 'git clone $REPO_URL /home/services/homelab-infrastructure && chown -R services:services /home/services/homelab-infrastructure'"
echo "  $SCRIPT_DIR/sync-vars.sh $HOSTNAME"
